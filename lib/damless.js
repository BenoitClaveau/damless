...
class DamLess extends EventEmitter {
    constructor(injector, config, event) {
        ...
        if (!event) throw new UndefinedError("event");
    ...
    async createHttpServer(config) {
        ...
        "request",
        "upgrade"].map(e => {
            this.httpServer.on(e, (...args) => this.emit(e, ...args));
        });
    ...
    async createHttpsServer(config) {
        ...
        "request",
        "upgrade"].map(e => {
            this.httpsServer.on(e, (...args) => this.emit(e, ...args));
        });
    ...
    async createHttp2SecureServer(config) {
        ...
        "stream",
        "timeout",
        "unknownProtocol"].map(e => {
            this.http2SecureServer.on(e, (...args) => this.emit(e, ...args));
        });
    ...
    async createHttp2Server(config) {
        ...
        "stream",
        "timeout"].map(e => {
            this.http2Server.on(e, (...args) => this.emit(e, ...args));
        });
