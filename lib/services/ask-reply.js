        ...
        if (/application\/json/.test(contentType)) {
            ...
            return new Transform({
                ...
                transform(chunk, encoding, callback) {
                    if (typeof chunk == "string") return callback(null, chunk);
                    if (Buffer.isBuffer(chunk)) return callback(null, chunk);
                    callback(null, chunk.toString()); // TODO to be change and move outside ask-reply
                }
            })
        }
