...
class AuthJWT {
    ...
    encode(payload, secret) {
        if (!secret) {
            if (this.config.http && this.config.http.jwt && this.config.http.jwt.secret) secret = this.config.http.jwt.secret;
            else if (this.config.https && this.config.https.jwt && this.config.https.jwt.secret) secret = this.config.https.jwt.secret;
        }
