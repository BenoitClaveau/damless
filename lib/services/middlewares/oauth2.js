...
class OAuth2Middleware {
    ...
    async getAccessToken(token) {
        ...
        // TODO en fonction du token il faut charger l'utilisateur.
    ...
    authorize(context, stream, headers) {
        ...
        //1. Si pas connecter rediriger vers le formulaire de login
        //2. Si déjà loggé redirigé vers le formulaire pour accépter
        //3  Sinon ok
        stream.redirect(redirect_uri)
