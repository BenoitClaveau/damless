...
class ReadableWritable extends Duplex {
    ...
    getReadableStream() {
        if (typeof this._readableArg == "function") {
            const streams = Array.from(this._readableArg());
    ...
    getWritableStream() {
        if (typeof this._writeableArg == "function") {
            const streams = Array.from(this._writeableArg());
